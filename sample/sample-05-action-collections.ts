import { ReducerWrapper, StoreWrapper, ActionCollections, combineReducerWrapper } from '../src';
...
export default function () {
  ...
  const actionCollections: ActionCollections = new ActionCollections("calc", {
